...
class Core_Debug {
    ...
    /**
     * Возвращает HTML-строку отладочной информации о любом количестве
     * переменные, каждая из которых "pre" tag:
     *
     *     // Displays the type and value of each variable
     *     echo Debug::vars($foo, $bar, $baz);
     *
     * @param   mixed   переменная для отладки
     * @param   ...
     * @return  string
     */
    public static function vars(){
        ...
        // Получить переданные переменные
    ...
    /**
     * Возвращает HTML-строку информации об одной переменной.
     *
     * Многократно переводит понятия из класса Debug [Nette](http://nettephp.com/).
     *
    ...
    /**
     * Helper для Debug::dump(), обрабатывает рекурсию в массивах и объектах.
     *
    ...
    /**
     * Удаляет application, system, modpath, or docroot из имени файла,
    ...
    /**
     * Возвращает строку HTML, выделяя определенную строку файла, с некоторыми
     * количество строк, заполненных сверху и снизу.
     *
    ...
    /**
     * Возвращает массив строк HTML, которые представляют каждый шаг в обратном направлении.
     *
     *     // Displays the entire current backtrace
     *     echo implode('<br/>', Debug::trace());
     *
     * @param   string  $trace path to debug
     * @return  string
     */
