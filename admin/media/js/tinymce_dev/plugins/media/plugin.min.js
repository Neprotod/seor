                ...
                items: [{
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            if (width > 1800 && (width = 1800), height > 1200 && (height = 1200), width > 600) {
                                var d = (width - 20) % 138;
                                width = width - d + 10
                            }
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=3&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder + '&dir=' + tinymce.settings.media_dir,
                                width: width,
                                height: height,
                                inline: 1
                            })
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=4&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder + '&dir=' + tinymce.settings.media_dir,
                                filetype: 'video',
                                width: width,
                                height: height,
                                inline: 1
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=5&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder + '&dir=' + tinymce.settings.media_dir,
                                filetype: 'image',
                                width: width,
                                height: height,
                                inline: 1
