...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:param name="parent" select="pages/category/parent_fields/field[@name = 'image_path']" />
    <xsl:param name="field" select="pages/category/fields/field[@name = 'image_path']" />
    <xsl:template match="/">
