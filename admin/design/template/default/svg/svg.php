...
return array(
    ...
    "home" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
                                        </svg>',
    "page" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                           <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline>
                                        </svg>',
    "users" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                           <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                                        </svg>',
    "orders" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                           <circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                                        </svg>',
    "moder" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                           <polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline>
                                        </svg>',
    "vacancies" => '<svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                           <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline>
                                        </svg>',

    "moderator" => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
                                            <path d="
                                                    M18.3,14.6c-0.1-2.4-0.2-5.3-0.2-8.2H18c-0.6,2.5-1.4,
                                                    5.4-2.2,7.7l-2.4,7.8H9.9l-2.1-7.7C7.1,11.8,6.4,9,6,
                                                    6.4H5.9c-0.1,2.7-0.2,5.8-0.4,8.2l-0.4,7.5H1L2.3,2.3h6l1.9,
                                                    6.6c0.6,2.3,1.2,4.8,1.7,7.1H12c0.6-2.3,1.2-4.9,1.9-7.1L16,
                                                    2.3h5.9L23,22.2h-4.4L18.3,14.6z"/>
                                        </svg>', 
    "custom" => '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-home">
    ...
    "plus" => '<svg viewBox="0 0 1290.000000 1290.000000" fill="none" stroke="currentColor" stroke-width="1"  class="feather feather-plus">
