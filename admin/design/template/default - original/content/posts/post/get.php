<form method="POST">
        ...
        <div class="description">
            ...
            <div class="date">
                ...
                <div class="create">
                    ...
                    <span class="string"><?=$post['date']?></span>
                </div>
                <div class="modified">
                    <?php
                    ...
                    <span class="string"><?=$post['modified']?></span>
                    <?php
                    else:
                    ?>
            ...
            <div class="status">
                <h2>Статус</h2>
                <label>
                    <input <?=($post['status'] == 1)? 'checked="checked"' : '' ?> type="radio" name="status" value="1" /> 
                    Активен
                </label>
                <label>
                    <input <?=($post['status'] == 0)? 'checked="checked"' : '' ?> type="radio" name="status" value="0" /> 
                    Откличен
                </label>
            </div>
            <div class="meta">
                ...
                <div class="meta_title">
                    ...
                    <span class="string">
                        <input type="text" name="meta_title" value="<?=Request::param($post['meta_title'])?>" />
                    </span>
                </div>
                <div class="meta_description">
                    <span class="name">Мета описание</span>
                    <div class="string">
                        <textarea name="description"><?=Request::param($post['description'],TRUE)?></textarea>
                    </div>
                </div>
    ...
    <div class="block loading">
        <h2>Контент</h2>
        <textarea name="content" id="content" class="content editor_large"><?=Str::html_encode($post['content'])?></textarea>
    </div>            
    <div class="block loading">
        <h2>Стили</h2>
        <div class="css">
            <h3>CSS</h3>
            <textarea name="css" id="css" style="width:400px;height:400px;"><?=Str::html_encode($post['css'])?></textarea>
        </div>
        <div class="js">
            <h3>JS</h3>
            <textarea name="js" id="js" style="width:400px;height:400px;"><?=Str::html_encode($post['js'])?></textarea>
        </div>
    </div>                
</form>
