<div style="max-width:400px; overflow:hidden; margin:10px auto; background:#fff; font-family: 'PT Sans', sans-serif; position:relative; border-radius:3px; box-shadow: 0 0 4px 0 rgba(0,0,0,.08), 0 2px 4px 0 rgba(0,0,0,.12); border:1px solid #ebebeb;">
    ...
    <div style="padding:20px;">
        <h2 style="margin:0;padding:10px 10px 20px 10px;text-align: center;font-size: 28px;font-weight: 400;font-family: 'PT Sans', sans-serif; color:green;">Ваши данные были подтверждены.
        </h2>
        <div>
            <div style="margin-bottom:10px;">Теперь у вас появится значок щита на аккаунте.</div>
        </div>
    </div>
