<div style="max-width:400px; overflow:hidden; margin:10px auto; background:#fff; font-family: 'PT Sans', sans-serif; position:relative; border-radius:3px; box-shadow: 0 0 4px 0 rgba(0,0,0,.08), 0 2px 4px 0 rgba(0,0,0,.12); border:1px solid #ebebeb;">
    ...
    <div style="padding:20px;">
        <h2 style="margin:0;padding:10px 10px 20px 10px;text-align: center;font-size: 28px;font-weight: 400;font-family: 'PT Sans', sans-serif;">Ответ службы поддержки на обращение №<?=$id?></h2>
        <div style="text-align:center;">
            <a class="btn" href="<?=Core::$root_url?>/account/support/appeal/<?=$id?>" style="display:inline-block; margin:auto; padding:10px; background:#81c757; text-decoration:none; color:#f5f5f5; border-radius:5px; margin-top:10px;">Перейти на ответ</a>
        </div>
    </div>
