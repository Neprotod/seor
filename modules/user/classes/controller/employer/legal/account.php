 ...
 * @category   page
 */
class Controller_Employer_Legal_Account_User{
    ...
    function fetch(){
        ...
        if($user["complete"] == 0 OR Request::get("edit"))
            Request::redirect(Url::site("edit", NULL));
        
        $this->error->cookie(FALSE);
        
        $xml_pars = "template|default::user_account_profile";
        $xsl_pars = "template|default::user_account";
    ...
    function edit(){
        ...
        // Парсер файла
        $xml_pars = "template|default::user_account_profile";
        $xsl_pars = "template|default::user_account_profile_legal";
