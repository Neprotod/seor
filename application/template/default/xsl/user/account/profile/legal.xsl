                            ...
                            <div class="d-flex flex-wrap">
                                <div id="main_information" class="">
                                    ...
                                    <div id="main_form" class="box_content margin-right">
                                        <div id="name_logo_box" class="d-flex margin-bottom">
                                            ...
                                            <div class="flex-grow-1 ">
                                                <div class="form-group control position-relative">
                                                    <span class="input_headline">Имя компании</span>
                                                    <xsl:choose>
                                                        <xsl:when test="account/user/@complete &gt; 0">
                                                            <input type="text" class="form-control" value="{account/user/@name}" disabled="disabled" />
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <input name="name" type="text" class="form-control" value="{account/user/@name}" active-role="name" required="required" />
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </div>
                                                <div class="form-group control position-relative">
                                                    <span class="input_headline">Деятельность</span>
                                                ...
                                                <div class="form-group control position-relative">
                                                    <span class="input_headline">Сайт</span>
                                                    <input name="fields[site][0]" type="text" class="form-control" value="{account/fields/site/field}" active-role="field_site" required="required" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-grow-1 flex-wrap">
                                            <div>
                                                <div class="form-group control position-relative d-flex">
                                                    <span class="input_headline">Дата регистрации компании</span>
                                                    <xsl:choose>
                                                        <xsl:when test="account/user/@complete &gt; 0">
                                        ...
                                        <div class="">
                                            <div class="form-group control position-relative">
                                                <span class="input_headline">Опишите компанию</span>
