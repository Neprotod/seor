...
<xsl:stylesheet version="1.0" 
                        ...
                        <div class="box_content">
                            <div id="main_information_box" class="d-flex">
                                    ...
                                    <div id="main_form" class="box_content margin-right flex-grow-1">
                                        <div class="d-flex margin-bottom">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div id="language_box" class="position-relative">
                                        ...
                                        <div class="">
                                            <div class="position-relative">
                                                <span class="input_headline position-static margin-bottom pt_sans">Навыки:</span>
                                ...
                                <div id="information" class="">
                                    <div class="box_content">
                                        <div id="user_specialization" class="position-relative">
                                            <span class="input_headline position-static margin-bottom pt_sans">Разделы и специализации</span>
    ...
    <xsl:template match="user_specialization">
        ...
        <li><xsl:value-of select="//account/specialization[@id = $id]" /></li>
    </xsl:template>
